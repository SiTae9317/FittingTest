...
public class MeshCombine : MonoBehaviour 
{
	...
	IEnumerator checkThread(System.Action endCallback)
	{
		...
		Transform removeCharTrs = charObj.GetComponentInChildren<SkinnedMeshRenderer> ().transform;
		...
		Transform removeClothTrs = clothObj.GetComponentInChildren<SkinnedMeshRenderer> ().transform;
